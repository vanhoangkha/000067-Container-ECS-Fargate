...
Docker hoạt động bằng cách cung cấp phương thức chuẩn để chạy mã của bạn. Docker là hệ điều hành dành cho container. Tương tự như cách máy ảo thực hiện ảo hóa (loại bỏ nhu cầu quản lý trực tiếp) phần cứng máy chủ, các container ảo hóa hệ điều hành của máy chủ. Docker được cài đặt trên từng máy chủ và cung cấp các lệnh đơn giản có thể được sử dụng để dựng, khởi động hoặc dừng container.
